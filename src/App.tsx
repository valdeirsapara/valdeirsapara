    ...
    <MainLayout>
      <div className="container mx-auto p-4 flex justify-between items-center">
        <div className="space-y-1.5">
          ...
          <h1 className="text-5xl font-bold">Olá, sou Valdeir Sapará</h1>
          <p className="text-3xl font-mono text-white/60">Desenvolvedor Full Stack</p>
        ...
        <div>
          <img src={photo} alt="Foto de Valdeir Sapará" className="rounded-full w-48 h-48 object-cover border-4 border-white/10" />
        </div>
      </div>
      {/* sobre mim */}
<div className="bg-stone-400/10 flex flex-col items-center space-y-10 py-10">
  ...
  <div className="w-4/5 mx-auto flex gap-10 justify-center">
